...
object OsInfo {
    ...
    val currentLinuxDesktopEnvironmentName: String
        get() = System.getenv("XDG_CURRENT_DESKTOP")

    val isGnome: Boolean
        get() = isLinux && currentLinuxDesktopEnvironmentName.lowercase().contains("gnome")
